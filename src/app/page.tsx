              ...
              <div className="bg-white dark:bg-gray-800 rounded-xl shadow-xl p-8 h-full">
                ...
                <div className="mt-10">
                  ...
                  <div className="flex space-x-4">
                   ...
                   <a 
  href="https://www.fiverr.com/s/NNlRBxN" 
  target="_blank" 
  rel="noopener noreferrer"
  className="w-10 h-10 flex items-center justify-center rounded-full bg-gray-100 dark:bg-gray-700 text-gray-600 dark:text-gray-300 hover:bg-primary-500 hover:text-white dark:hover:bg-primary-500 transition-colors"
>
  <svg 
