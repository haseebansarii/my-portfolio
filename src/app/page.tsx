              ...
              <div className="bg-white dark:bg-gray-800 rounded-xl shadow-xl p-8 h-full">
                ...
                <div className="space-y-6">
                  <div className="flex items-start">
                    ...
                    <div>
                      ...
                      <a href="mailto:ansarihaseeb615@gmail.com" className="text-primary-600 dark:text-primary-400 hover:underline">formegaapp07@gmail.com</a>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start">
                    ...
                    <div>
                      ...
                      <a href="tel:+123456789" className="text-secondary-600 dark:text-secondary-400 hover:underline">+1 (234) 567-890</a>
                    </div>
                  </div>
                ...
                <div className="mt-10">
                  ...
                  <div className="flex space-x-4">
                    <a href="#" className="w-10 h-10 flex items-center justify-center rounded-full bg-gray-100 dark:bg-gray-700 text-gray-600 dark:text-gray-300 hover:bg-primary-500 hover:text-white dark:hover:bg-primary-500 transition-colors">
