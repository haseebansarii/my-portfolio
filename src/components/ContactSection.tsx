...
import { Send, ExternalLink, Github, Linkedin, Mail, MessageSquare, CheckCircle } from 'lucide-react';
            ...
            <form onSubmit={handleSubmit} className="p-6 lg:p-8 rounded-2xl glass-panel glass-shine">
              ...
              <div className="space-y-5">
                ...
                <motion.button
                  ...
                  whileTap={{ scale: 0.98 }}
                  className="w-full flex items-center justify-center gap-2 px-6 py-3.5 bg-slate-900 dark:bg-white/90 text-white dark:text-[#080c12] font-semibold rounded-xl hover:bg-slate-800 dark:hover:bg-white transition-all hover:shadow-lg hover:shadow-white/10 backdrop-blur-sm"
                >
                  {submitted ? (
                    <>
